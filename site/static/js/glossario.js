...
const GLOSSARIO = [
  ...
  { key:'cpc_org_didatico', sigla:'Org. didático-pedagógica', nome:'Organização didático-pedagógica', cat:'Qualidade',
    oque:'Nota média (1 a 6) que os próprios estudantes dão à organização didático-pedagógica do curso — currículo, didática, formas de avaliação. Coletada no Questionário do Estudante do ENADE.',
    escala:'1 a 6', dir:'maior', fonte:'INEP / CPC 2023', aliases:['org. didatico','didatico-pedag','organizacao didatico'] },
  { key:'cpc_infraestrutura', sigla:'Infraestrutura', nome:'Infraestrutura e instalações físicas', cat:'Qualidade',
    oque:'Nota média (1 a 6) atribuída pelos estudantes à infraestrutura física do curso — laboratórios, biblioteca, salas e equipamentos. Coletada no Questionário do Estudante do ENADE.',
    escala:'1 a 6', dir:'maior', fonte:'INEP / CPC 2023', aliases:['infraestrutura','instalacoes fisicas','infra'] },
  { key:'cpc_oportunidade', sigla:'Oportunidade de ampliação', nome:'Oportunidade de ampliação da formação', cat:'Qualidade',
    oque:'Nota média (1 a 6) dada pelos estudantes às oportunidades de ampliar a formação além da sala de aula — pesquisa, extensão, monitoria, estágios e internacionalização.',
    escala:'1 a 6', dir:'maior', fonte:'INEP / CPC 2023', aliases:['oportunidade de ampliacao','ampliacao da formacao','oportun'] },
